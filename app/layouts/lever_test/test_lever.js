...
export default class LeverTest extends Component {
            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 3.5, }}>
                    ...
                    <View style={{ flex: 3, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        <View style={{ flex: 1 }}>
                            <View style={[styles.line, { flex: 1 }]}>
                                <View style={[styles.ul1, { justifyContent: 'center', alignItems: 'center' }]}>
                                </View>
                                <Text style={{}}>You bla bla bla bla bla bla bla bla</Text>
                            </View>
                            <View style={[styles.line, { flex: 1 }]}>
                                <View style={[styles.ul1, { justifyContent: 'center', alignItems: 'center' }]}>
                                </View>
...
// AppRegistry.registerComponent('OneAskIU', () => LeverTest);
